...
/* Line 678 of lalr1.cc  */
#line 13 "parser.y"
    { cout << "Variable " << yylval_str << " = " << yylval_num << endl; }
    break;
...
#line 422 "parser.tab.cc"
  ...
  {
    "$end", "error", "$undefined", "NUMBER", "IDENT", "PRINT", "LET", "';'",
  "'='", "$accept", "program", "stmt", 0
  };
#endif
